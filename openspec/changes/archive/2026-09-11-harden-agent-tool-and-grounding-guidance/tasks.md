...
- [x] 3.4 Run `make check` as the final local verification gate and verify backend tests, frontend lint/tests/build, Ruff checks, and strict OpenSpec validation all pass before implementation review, archive, and pull-request preparation.
