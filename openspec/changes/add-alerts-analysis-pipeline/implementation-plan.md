...
| VS-04 | Persist every mandatory failure with no Alert artifact | VS-03 | high-risk | IN_PROGRESS | - | - |
| VS-05 | Execute the bounded optional registry and retain only allowed failure traces | VS-03 | high-risk | READY | - | - |
