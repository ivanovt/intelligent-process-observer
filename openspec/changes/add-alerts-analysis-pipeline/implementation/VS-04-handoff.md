...
PostgreSQL fixture now supplies a canonical typed, strictly in-window record and proves
the injected analyzer was called before its forced failure. The persistence seam advances
a failed LensRun without inserting an Alert result; usable outcomes retain their existing
artifact path.
