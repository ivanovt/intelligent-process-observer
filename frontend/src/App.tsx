...
export default function App() {
  return <Routes><Route element={<AppShell />}><Route path="/observations" element={<ObservationsPage />} /><Route path="/observations/new" element={<CreateRoutes/>}><Route index element={<CreateObservationPage/>}/><Route path="alert-lenses/:key" element={<AlertLensEditorPage/>}/><Route path="metric-lenses/:key" element={<MetricLensEditorPage/>}/><Route path="relationships/:key" element={<DraftlessEditor/>}/></Route><Route path="/observations/:observationId" element={<ObservationDetailPage />} /><Route path="/" element={<Navigate to="/observations" replace />} /><Route path="*" element={<Navigate to="/observations" replace />} /></Route></Routes>
}
