...
export default function App() {
  return <Routes><Route element={<AppShell />}><Route path="/overview" element={<OverviewPage />} /><Route path="/knowledge" element={<KnowledgePage />} /><Route path="/observations" element={<ObservationsPage />} /><Route path="/observations/new" element={<CreateRoutes/>}><Route index element={<CreateObservationPage/>}/><Route path="alert-lenses/:key" element={<AlertLensEditorPage/>}/><Route path="metric-lenses/:key" element={<MetricLensEditorPage/>}/><Route path="relationships/:key" element={<RelationshipEditorPage/>}/></Route><Route path="/observations/:observationId/edit" element={<EditRoutes/>}><Route index element={<EditObservationPage/>}/><Route path="alert-lenses/:key" element={<AlertLensEditorPage/>}/><Route path="metric-lenses/:key" element={<MetricLensEditorPage/>}/><Route path="relationships/:key" element={<RelationshipEditorPage/>}/></Route><Route path="/observations/:observationId" element={<ObservationDetailPage />} /><Route path="/runs" element={<RunsPage />} /><Route path="/runs/:observationRunId" element={<RunDetailPage />} /><Route path="/data-sources" element={<DataSourcesPage />} /><Route path="/" element={<Navigate to="/overview" replace />} /><Route path="*" element={<Navigate to="/observations" replace />} /></Route></Routes>
}
