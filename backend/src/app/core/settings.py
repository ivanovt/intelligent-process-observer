...
class Settings(BaseSettings):
    ...
    knowledge_embedding_dimensions: int = Field(default=1_536, ge=1_536, le=1_536)
    ...
    knowledge_retrieval_max_passages: int = Field(default=4, ge=4, le=4)
    knowledge_retrieval_max_serialized_bytes: int = Field(default=8_192, ge=8_192, le=8_192)
    knowledge_retrieval_timeout_seconds: float = Field(default=30, ge=30, le=30)
