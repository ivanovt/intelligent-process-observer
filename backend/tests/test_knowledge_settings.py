...
def test_knowledge_settings_accept_server_side_overrides() -> None:
    settings = Settings(
    ...
    assert settings.knowledge_retrieval_max_passages == 2
    assert settings.knowledge_retrieval_max_serialized_bytes == 4_096
    assert settings.knowledge_retrieval_timeout_seconds == 15.5
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("knowledge_retrieval_max_passages", 0),
        ("knowledge_retrieval_max_serialized_bytes", 0),
        ("knowledge_retrieval_timeout_seconds", 0),
